...
public static class TextureExtensions {
    ...
    public static Texture2D Slice(this Texture2D source, GraphicsDevice device, Rectangle sourceArea) {
        Color[] colors = new Color[sourceArea.Width * sourceArea.Height];
        source.GetData(0, sourceArea, colors, 0, colors.Length);

        Texture2D texture2D = new(device, sourceArea.Width, sourceArea.Height, false, SurfaceFormat.Color);
